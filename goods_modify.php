...
<body>
    ...
    <section>
        <div id="goods_box">
            <h3 id="goods_title">COMMUNITY > GOODS > MODIFY</h3>
            <?php
            if (!$userid) {
                echo("<script>
				    alert('로그인 후 이용해주세요!');
                ...
                <ul id="goods_form">
                    ...
                    <li>
                        ...
                        <span class="col2">
                            ...
                            <input type="checkbox" value="yes" name="file_delete">&nbsp;FILE DELETE
                            <br>FILE : <?= $file_name ?>
                        </span>
                    </li>
                </ul>
                <ul class="buttons">
                  <li><button type="button" onclick="check_input()">OK</button></li>
