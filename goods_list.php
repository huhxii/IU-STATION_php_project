    ...
    <section>
        <div id="goods_box">
            ...
            <ul id="goods_list">
                ...
                $sql = "select count(*) from goods order by num desc";
                ...
                $sql = "select * from goods order by num desc LIMIT $start, $scale";
                $result = mysqli_query($con, $sql);
                $i = 0;
                ...
                for($i=0; $i< count($list); $i++){
                    ...
                    if (!empty($list[$i]['file_name'])) {
                        ...
                        if ($image_height > 400 ) $image_height = 400;
                        $file_copied_0 = $list[$i]['file_copied'];
                    }
                ?>
                <li>
                    <span>
                        <a href="goods_view.php?num=<?= $list[$i]['num'] ?>&page=<?= $page ?>">
                        <?php 
            ...
            <ul id="page_num">
                <?php
	            $url = "goods_list.php?page=1";
	            echo get_paging(3, $page, $total_page, $url);
                ?>
            </ul>
            <ul class="buttons">
                <li><button onclick="location.href='goods_list.php'">LIST</button></li>
                <li>
                    <?php 
                    if($userid){
                    ?>
