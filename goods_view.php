    ...
    <section>
        <div id="goods_box">
            ...
            <ul id="goods_list2">
                ...
                if ($userid !== $id) {
                    $new_hit = $hit + 1;
                    $sql = "update goods set hit=$new_hit where num=$num";
            ...
            <div id="ripple">
                ...
                <div id="ripple2">
                    <?php
                    $sql = "select * from `goods_ripple` where parent='$num' ";
                    ...
                    <div id="ripple_title">
                        <ul>
                            ...
                            if ($_SESSION['userid'] == "admin" || $_SESSION['userid'] == $ripple_id) {
                                echo '<form style="display:inline" action="imagegoods_dml.php" method="post">
                    ...
                    mysqli_close($con);
                    ?>
                    <form name="ripple_form" action="goods_dml.php" method="post">
        ...
        <div id="write_button">
            <ul class="buttons">
                <li>
                    <button onclick="location.href='goods_list.php?page=<?= $page ?>'">LIST</button>
                </li>
                <li>
                    <form action="goods_modify.php" method="post">
                ...
                <li>
                    <form action="goods_dml.php" method="post">
                ...
                <li>
                    <button onclick="location.href='goods.php'">WRITE</button>
                </li>
            </ul>
        </div>
    </section>
